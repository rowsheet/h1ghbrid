...
#		if (value):
#			return mark_safe("""
#				<div style="background: green; color: white; border-radius: 3px; text-align: center;">True</div>
#			""")
#		return mark_safe("""
#			<div style="background: red; color: white; border-radius: 3px; text-align: center;">False</div>
#		""")
#	
